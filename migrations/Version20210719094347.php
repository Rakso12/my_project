 ...
 */
final class Version20210719094347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE my_oauth_access_token (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifier VARCHAR(255) DEFAULT NULL COLLATE BINARY, client_id VARCHAR(255) DEFAULT NULL COLLATE BINARY, make_date DATE DEFAULT NULL, is_active BOOLEAN NOT NULL, user_id VARCHAR(255) DEFAULT NULL, scopes VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__my_oauth_client AS SELECT id, identifier, name, secret, grants, scopes, is_active FROM my_oauth_client');
        $this->addSql('DROP TABLE my_oauth_client');
        $this->addSql('CREATE TABLE my_oauth_client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifier VARCHAR(255) DEFAULT NULL COLLATE BINARY, name VARCHAR(255) DEFAULT NULL COLLATE BINARY, secret VARCHAR(255) DEFAULT NULL COLLATE BINARY, grants VARCHAR(255) NOT NULL COLLATE BINARY, scopes VARCHAR(255) NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO my_oauth_client (id, identifier, name, secret, grants, scopes, is_active) SELECT id, identifier, name, secret, grants, scopes, is_active FROM __temp__my_oauth_client');
        $this->addSql('DROP TABLE __temp__my_oauth_client');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__my_oauth_access_token AS SELECT id, identifier, client_id, make_date, user_id, scopes, is_active FROM my_oauth_access_token');
        $this->addSql('DROP TABLE my_oauth_access_token');
        $this->addSql('CREATE TABLE my_oauth_access_token (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifier VARCHAR(255) DEFAULT NULL, client_id VARCHAR(255) DEFAULT NULL, make_date DATE DEFAULT NULL, is_active BOOLEAN NOT NULL, user_id INTEGER DEFAULT NULL, scopes CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        )');
        $this->addSql('INSERT INTO my_oauth_access_token (id, identifier, client_id, make_date, user_id, scopes, is_active) SELECT id, identifier, client_id, make_date, user_id, scopes, is_active FROM __temp__my_oauth_access_token');
        $this->addSql('DROP TABLE __temp__my_oauth_access_token');
        $this->addSql('CREATE TEMPORARY TABLE __temp__my_oauth_client AS SELECT id, identifier, name, secret, grants, scopes, is_active FROM my_oauth_client');
        $this->addSql('DROP TABLE my_oauth_client');
        $this->addSql('CREATE TABLE my_oauth_client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, identifier VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, secret VARCHAR(255) DEFAULT NULL, grants VARCHAR(255) NOT NULL, scopes VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT \'true\' NOT NULL)');
        $this->addSql('INSERT INTO my_oauth_client (id, identifier, name, secret, grants, scopes, is_active) SELECT id, identifier, name, secret, grants, scopes, is_active FROM __temp__my_oauth_client');
        $this->addSql('DROP TABLE __temp__my_oauth_client');
        $this->addSql('DROP INDEX IDX_454D9673C7440455');
        $this->addSql('CREATE TEMPORARY TABLE __temp__oauth2_access_token AS SELECT identifier, client, expiry, user_identifier, scopes, revoked FROM oauth2_access_token');
