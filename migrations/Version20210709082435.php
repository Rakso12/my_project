 ...
 */
final class Version20210709082435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, first_name, password, is_verified FROM user');
        ...
        , first_name VARCHAR(255) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, is_verified BOOLEAN NOT NULL, last_name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, first_name, password, is_verified) SELECT id, email, roles, first_name, password, is_verified FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        , first_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, is_verified BOOLEAN DEFAULT \'FALSE\' NOT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, first_name, password, is_verified) SELECT id, email, roles, first_name, password, is_verified FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
