 ...
 */
final class Version20210721131819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post ADD COLUMN hashtags VARCHAR(255) NOT NULL DEFAULT "none"');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__oauth2_refresh_token');
        $this->addSql('CREATE INDEX IDX_4DD90732B6A2DD68 ON oauth2_refresh_token (access_token)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__post AS SELECT id, content, author FROM post');
        ...
        $this->addSql('INSERT INTO post (id, content, author) SELECT id, content, author FROM __temp__post');
